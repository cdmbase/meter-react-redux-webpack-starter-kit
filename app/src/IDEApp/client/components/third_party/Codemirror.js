/**
 *  Temporarily add the react-code-mirror until the author upgrade with lates pull requests
 *
 *  TODO: Get it from npm package or create a npm package
 */
...
const CodeMirror = React.createClass({
    ...
    componentDidMount () {
        ...
        this.codeMirror = codeMirrorInstance(function(elt){
