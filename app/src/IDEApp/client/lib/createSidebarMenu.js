...
// {
//   name: 'Main menu', // This is just a name to identify your menu (useful if you got more than
// one) menuItems: [ // main menu items { title: 'Dashboard', link: null, children: [ // submenu
// items { title: 'Submenu 1', link: '#', children: [], icon: 'sidebar-sub-link fa fa-circle-thin',
// // FontAwesome icon className }, { title: 'Submenu 2', link: '#', children: [], icon:
// 'sidebar-sub-link fa fa-circle-think', }, ... // rest of your submenu items ], icon: 'fa
// fa-signal fa-fw', notificcationCount: null }, ... // rest of your main menu items ], };
