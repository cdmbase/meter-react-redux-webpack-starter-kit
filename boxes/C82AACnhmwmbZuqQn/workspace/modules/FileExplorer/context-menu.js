...
import { FILE_EXPLORER_CONTEXT, TYPE_DIR, TYPE_FILE } from 'MainApp/common/box/menu-types';
import { tasks } from 'MainApp/common/box/boxes-actions';
    ...
    click(event, module) {
        ...
        switch (act) {
            ...
            case ACT_DOWNLOAD:
                break;
            case ACT_NEW_FILE:
                action.create(id, {module});
                break;
            case ACT_NEW_FOLDER:
                actions.create(id, {module});
                break;
            case ACT_REMOVE:
